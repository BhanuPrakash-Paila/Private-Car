...
export default function BookingForm() {
  return (
    <div className="relative max-w-7xl mx-auto w-full px-4">
      <form className="bg-white rounded-xl shadow-lg px-8 py-6 flex flex-col md:flex-row items-center gap-4 border-t-4 border-yellow-400 w-full">
        ...
        <div className="flex flex-col gap-2 w-full md:w-[150px]">
          ...
          <input type="date" className="rounded border px-3 py-2 w-[150px]" />
        </div>
        <div className="flex flex-col gap-2 w-full md:w-[150px]">
          <label className="font-semibold text-zinc-700 mb-1">Pick-up Time</label>
          <input type="time" className="rounded border px-3 py-2 w-[150px]" defaultValue="00:00" />
        </div>
        <div className="flex flex-col gap-2 w-full md:w-[150px]">
